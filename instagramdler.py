...
get = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"XCO"+Fore.BLUE+"~"+Fore.WHITE+Fore.LIGHTYELLOW_EX+"geting ID"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"卐 ")
get2 = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"XCO"+Fore.BLUE+"~"+Fore.WHITE+Fore.LIGHTYELLOW_EX+"your username"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"卐 ")
get3 = input(Fore.RED+" ┌─["+Fore.LIGHTGREEN_EX+"XCO"+Fore.BLUE+"~"+Fore.WHITE+Fore.LIGHTYELLOW_EX+"yor password"+Fore.RED+"""]
 └──╼ """+Fore.WHITE+"卐 ")
gets = get
INSTAGRAM_USERNAME = get
bot = Bot()
bot.login(username = get2,password = get3)
...
for i in range(a):
    w = arr[i]
    bot.upload_photo(w,caption ="like and follow !")
